...
public class SwagLabLoginTest extends BaseClass
{
	...
	{
		TCID=102;
		String actProductName=home.getSwagLabHomePageProductList();
		String expProductName=UtilityClass.getTD(1,1);
		Assert.assertEquals(actProductName,expProductName,"Failed : Product onesie ius not same");
	}
